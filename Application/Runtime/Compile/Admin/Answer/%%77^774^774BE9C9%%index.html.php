<?php /* Smarty version 2.6.26, created on 2015-08-02 10:30:47
         compiled from index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'index.html', 26, false),)), $this); ?>
...
?>
		<tr>
			<td><?php echo $this->_tpl_vars['data'][$this->_sections['n']['index']]['anid']; ?>
</td>
			...
			<td>
				<a href="index.php?m=Admin&c=Answer&a=del&anid=<?php echo $this->_tpl_vars['data'][$this->_sections['n']['index']]['anid']; ?>
" class="del">删除</a>
			</td>
		</tr>
	<?php endfor; endif; ?>	
